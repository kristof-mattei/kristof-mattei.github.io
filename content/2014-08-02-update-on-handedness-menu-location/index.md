...
[taxonomies]
categories = ["Windows 7", "Windows 8", "Windows 8.1", "Windows"]

[extra]
author = "Kristof"
+++

A while back I wrote how to change the [handedness](../2014-05-15-menu-on-the-wrong-side-with-a-touch-screen/index.md) (which seems to be the correct term, instead of the dreadful 'Menu on the wrong side with a touch screen').
